...
#' @docType data
#'
#' @usage data(subincr_matrix6)
#'
#' @format A data frame with 1291 rows and 20 variables:
#'
#' \describe{
...
#'   \item{WeightI}{Mass of shell material between subsequent subincrements}
#'   \item{Growth_rate}{Mass of shell material accumulated per day}
#'   \item{WeightC}{Mass of shell material between subincrement and top of shell}
#' }
